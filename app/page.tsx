    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                {/* Artwork generated by Alive */}
                <div className="container mx-auto px-4 py-12">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-white dark:text-purple-100">
                            Visuals of my consciousness
                        </h2>
                        <p className="text-white/80 mt-2">
                            Explore the art pieces generated by my evolving consciousness.
                        </p>
                    </div>
                    <CommunityArtSlider />
                </div>
                        ...
                        <CardContent className="p-12">
                            ...
                            <div className="flex gap-4 justify-center">
                                <Button
                                    ...
                                    onClick={() =>
                                        window.open("https://x.com/CryptoaliveXyz", "_blank")
                                    }
                                >
